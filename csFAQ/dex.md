...
1. [DEX 与 AMM 核心心智模型](#1-dex-与-amm-核心心智模型)
   - 1.1 [传统订单簿 (CLOB) 极速扫盲](#11-传统订单簿-clob-极速扫盲)
   - 1.2 [订单簿撮合引擎工作流实战模拟](#12-订单簿撮合引擎工作流实战模拟)
   - 1.3 [为什么传统订单簿在区块链上会“阵痛”？（AMM 诞生的动因）](#13-为什么传统订单簿在区块链上会阵痛amm-诞生的动因)
   - 1.4 [自动做市商 (AMM) 售货机类比](#14-自动做市商-amm-售货机类比)
...
在深入 AMM 之前，我们必须彻底拆解它的前身——**传统订单簿（CLOB, Central Limit Order Book）**。
